...
Inclusive and fiducial measurements of the cross section have been established by the ATLAS and CMS collaborations at 8~TeV. The ratio of the top quark over the antiquark cross section display a similar tension for some PDF sets as measured by both collaborations. Furthermore, insight into the electroweak coupling structure is gained by a novel analysis technique that utilizes an event-based likelihood to set limits on the anomalous tensor-like right-handed Wtb coupling.

Finally, an early cross section measurement was presented that uses the first data at 13~TeV after the LHC restart.
